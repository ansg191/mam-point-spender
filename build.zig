...
pub fn build(b: *std.Build) void {
    ...
    const mod = b.addModule("mam_point_spender", .{
        ...
        .target = target,
        .imports = &.{.{ .name = "zeit", .module = zeit.module("zeit") }},
    });
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "mam_point_spender" is the name you will use in your source code to
                // import this module (e.g. `@import("mam_point_spender")`). The name is
